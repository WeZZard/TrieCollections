...
public struct TrieDictionaryBreadthFirstIterator<
    ...
    >: IteratorProtocol
{
    ...
    internal typealias _Impl = _TrieBreadthFirstIteratorImpl<_KeyValueContainer>
    
    internal var _impl: _Impl
    
    public init(view: TrieDictionaryBreadthFirstView<K, V>) {
