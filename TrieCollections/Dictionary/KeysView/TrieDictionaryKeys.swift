...
public struct TrieDictionaryKeys<K: TriePrefixInterpretable, V>:
    Collection
{
    ...
    public typealias Iterator = TrieDictionaryKeysIterator<K, V>
    ...
    public subscript(position: Index) -> Element {
        return _trieDictionary[position].key
    }
}
