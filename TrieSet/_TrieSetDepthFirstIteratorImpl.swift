//
//  _TrieSetDepthFirstIteratorImpl.swift
//  TrieSet
//
...
///
/// - Note: Because for a hash table, there isn't a promised dterministic
/// order for a sequence of given inputs, this class just named depth-
/// first but not pre-order, in-order or post-order.
///
internal class _TrieSetDepthFirstIteratorImpl<E: TriePrefixing>:
    _TrieSetIteratorImpl<E>
{
    ...
    internal init(impl: _TrieSetDepthFirstIteratorImpl) {
        _stack = impl._stack
