//
//  TrieDctionaryBreadthFirstIteratorTests.swift
//  TrieCollections
//
...
class TrieDctionaryBreadthFirstIteratorTests: XCTestCase {
    typealias Iterator = TrieDictionaryBreadthFirstIterator<TrieKey, Int>
